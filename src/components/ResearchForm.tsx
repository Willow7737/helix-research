  ...
  const [dataSources, setDataSources] = useState<DataSource[]>([
    {
      ...
      description: "arXiv, PubMed, Google Scholar, IEEE Xplore, ACM Digital Library",
      icon: FileText,
      enabled: true,
    },
    {
      ...
      description: "USPTO, EPO, WIPO, national patent offices worldwide",
      icon: Shield,
      enabled: false,
    },
    {
      ...
      description: "Kaggle, UCI ML, government open data, institutional repositories",
      icon: Database,
      enabled: false,
    },
    {
      id: "forum",
      name: "Scientific Communities",
      description: "ResearchGate, Stack Overflow, Reddit Science, specialized forums",
      icon: MessageSquare,
      enabled: false,
    },
    {
      ...
      description: "Real-time web scraping, news analysis, industry reports",
      icon: Search,
      enabled: true,
    },
    {
      ...
      description: "Market data, SEC filings, earnings reports, analyst notes",
      icon: Sparkles,
      enabled: false,
    },
  ]);
